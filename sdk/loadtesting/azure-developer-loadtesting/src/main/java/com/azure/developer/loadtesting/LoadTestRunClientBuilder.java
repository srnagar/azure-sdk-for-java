...
@ServiceClientBuilder(serviceClients = {LoadTestRunAsyncClient.class})
public final class LoadTestRunClientBuilder
     ...
     */
    @Generated
    public LoadTestRunClientBuilder apiVersion(String apiVersion) {
     ...
     */
    @Generated
    public LoadTestRunClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
