...
@ServiceClientBuilder(serviceClients = {LoadTestAdministrationAsyncClient.class})
public final class LoadTestAdministrationClientBuilder
     ...
     */
    @Generated
    public LoadTestAdministrationClientBuilder apiVersion(String apiVersion) {
     ...
     */
    @Generated
    public LoadTestAdministrationClientBuilder serializerAdapter(SerializerAdapter serializerAdapter) {
    ...
    private LoadTestingClientImpl buildInnerClient() {
        ...
        String localApiVersion = (apiVersion != null) ? apiVersion : "2022-11-01";
        SerializerAdapter localSerializerAdapter =
                (serializerAdapter != null) ? serializerAdapter : JacksonAdapter.createDefaultSerializerAdapter();
        LoadTestingClientImpl client =
                new LoadTestingClientImpl(localPipeline, localSerializerAdapter, this.endpoint, localApiVersion);
        return client;
    }
