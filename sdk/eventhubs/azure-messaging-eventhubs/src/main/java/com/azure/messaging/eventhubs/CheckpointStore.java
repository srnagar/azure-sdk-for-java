...
public interface CheckpointStore {
    ...
    /**
     * Called to get the list of checkpoints from the underlying data store. This method could return empty results
     * if there are no checkpoints available ins the data store.
     *
     * @param fullyQualifiedNamespace  The fully qualified namespace of the Event Hub.
     * @param eventHubName The Event Hub name to get ownership information.
     * @param consumerGroup The consumer group name.
     * @return A flux of checkpoints
     */
    Flux<Checkpoint> listCheckpoints(String fullyQualifiedNamespace, String eventHubName,
        String consumerGroup);
