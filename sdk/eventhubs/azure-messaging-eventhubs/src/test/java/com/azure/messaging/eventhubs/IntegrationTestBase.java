...
import static com.azure.core.amqp.models.ProxyOptions.PROXY_PASSWORD;
import static com.azure.core.amqp.models.ProxyOptions.PROXY_USERNAME;
...
public abstract class IntegrationTestBase extends TestBase {
    ...
    protected EventHubClientBuilder createBuilder(boolean useCredentials) {
        final EventHubClientBuilder builder = new EventHubClientBuilder()
            .proxy(ProxyOptions.SYSTEM_DEFAULTS)
            .scheduler(scheduler)
            .retry(RETRY_OPTIONS)
