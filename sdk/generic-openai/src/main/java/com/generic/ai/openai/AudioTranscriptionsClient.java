...
import com.generic.ai.openai.implementation.AudioTranscriptionsImpl;
import com.generic.ai.openai.implementation.MultipartFormDataHelper;
import com.generic.ai.openai.models.CreateTranscriptionRequest;
import com.generic.ai.openai.models.CreateTranscriptionResponse;
...
public final class AudioTranscriptionsClient {
    @Metadata(generated = true)
    private final AudioTranscriptionsImpl serviceClient;

    /**
     * Initializes an instance of AudioTranscriptionsClient class.
     * 
     * @param serviceClient the service client implementation.
     */
    @Metadata(generated = true)
    AudioTranscriptionsClient(AudioTranscriptionsImpl serviceClient) {
    ...
    @Metadata(generated = true)
    @ServiceMethod(returns = ReturnType.SINGLE)
    public CreateTranscriptionResponse createTranscription(CreateTranscriptionRequest audio) {
        ...
        return createTranscriptionWithResponse(new MultipartFormDataHelper(requestOptions)
            ...
            .serializeTextField("language", audio.getLanguage()).end().getRequestBody(), requestOptions).getValue()
                .toObject(CreateTranscriptionResponse.class);
    }
}
