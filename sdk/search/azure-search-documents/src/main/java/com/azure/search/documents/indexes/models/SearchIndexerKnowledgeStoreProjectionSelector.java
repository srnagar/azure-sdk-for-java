...
public class SearchIndexerKnowledgeStoreProjectionSelector
     ...
     * @return An instance of SearchIndexerKnowledgeStoreProjectionSelector if the JsonReader was pointing to an
     * instance of it, or null if it was pointing to JSON null.
     * @throws IOException If an error occurs while reading the SearchIndexerKnowledgeStoreProjectionSelector.
     */
    public static SearchIndexerKnowledgeStoreProjectionSelector fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            SearchIndexerKnowledgeStoreProjectionSelector deserializedSelector
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("referenceKeyName".equals(fieldName)) {
                    deserializedSelector.referenceKeyName = reader.getString();
                } else if ("generatedKeyName".equals(fieldName)) {
                    deserializedSelector.generatedKeyName = reader.getString();
                } else if ("source".equals(fieldName)) {
                    deserializedSelector.source = reader.getString();
                } else if ("sourceContext".equals(fieldName)) {
                    deserializedSelector.sourceContext = reader.getString();
                } else if ("inputs".equals(fieldName)) {
                    deserializedSelector.inputs = reader.readArray(InputFieldMappingEntry::fromJson);
                } else {
                    reader.skipChildren();
                }
            }
